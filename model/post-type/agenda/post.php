...
function dm_add_post_type_agenda() 
{
  $singular = 'agenda';
  $singularCameo = 'Agenda';
  $slug = 'agenda';
  $genderChar = 'a'; 
  ...
  'name'            => _x($singularCameo.'s', 'post type general name', 'your-plugin-textdomain' ),
    ...
    'menu_name'     => _x($singularCameo.'', 'admin menu', 'your-plugin-textdomain' ),
...
add_action('init', 'dm_add_post_type_agenda');
